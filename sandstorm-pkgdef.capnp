...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "z7za0nz4mwykzcz7zgpttmhyt5kzkgpqq2xhtg6vucg0pp3tmhsh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Hakyll CMS"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New Hakyll CMS Site"),
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (svg = embed "app-graphics/sshakyll-128.svg"),
        grain = (svg = embed "app-graphics/sshakyll-24.svg"),
        market = (svg = embed "app-graphics/sshakyll-150.svg"),
      ...
      codeUrl = "https://github.com/Lupino/sshakyll",
      ...
      author = (
        ...
        contactEmail = "lmjubuntu@gmail.com",
        ...
        upstreamAuthor = "YunTan App Team",
      ...
      screenshots = [
        ...
        (width = 640, height = 480, png = embed "app-graphics/screenshot.png")
      ],
...
const startCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "8000", "--", "/startup.sh"],
  environ = [
...
const continueCommand :Spk.Manifest.Command = (
  # Here we define the command used to start up your server.
  argv = ["/sandstorm-http-bridge", "8000", "--", "/bin/sshakyll"],
  environ = [
    # Note that this defines the *entire* environment seen by your app.
    (key = "PATH", value = "/usr/local/bin:/usr/bin:/bin"),
    (key = "SANDSTORM", value = "1"),
